 ...
 * @author Admin
 */
@WebServlet(name="DienThongTinControl", urlPatterns={"/thongtin"})
public class DienThongTinControl extends HttpServlet {
...
//        list.add(x);
//        double vat = x.getPrice() / 10.0;
//        double all = vat + x.getPrice();
