    ...
    <body>
        <div id="logreg-forms">
            <form class="form-signin" action="dangnhap" method="post">
                ...
                <input name="user"  type="text" id="username1" class="form-control" placeholder="Username" required="" autofocus="">
                <input name="pass"  type="password1" id="password" class="form-control" placeholder="Password" required="">
            ...
            <form action="dangki" method="post" class="form-signup">
